...
public class UberXCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder parentViewHolder, final int position) {
        ...
        if (parentViewHolder instanceof ViewHolder) {
            ...
            Picasso.get().load(vLogo_image.equals("") ? CommonUtilities.SERVER : imageURL).placeholder(R.mipmap.ic_no_icon).into(viewHolder.catImgView, new Callback() {
                @Override
            ...
            Picasso.get().load(vBannerImage.equals("") ? CommonUtilities.SERVER : imageURL).placeholder(R.mipmap.ic_no_icon).into(holder.bannerImgView, new Callback() {
                @Override
                public void onSuccess() {
                ...
                public void onError(Exception e) {
                    ...
                    if (!vBannerImage.contains("http") && !vBannerImage.equals("")) {
                        Picasso.get().load(GeneralFunctions.parseIntegerValue(0, vBannerImage)).placeholder(R.mipmap.ic_no_icon).error(R.mipmap.ic_no_icon).into(holder.bannerImgView);
                    }
                }
            });
    ...
    public class BannerViewHolder extends RecyclerView.ViewHolder {
        ...
        public BannerViewHolder(View view) {
            ...
            bookNowImg=(ImageView)view.findViewById(R.id.bookNowImg);
