...
//        layParams.rightMargin = Utils.dipToPixels(getActContext(), 15);
    ...
    public class setOnClick implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            } else if (i == btn_type2.getId() || i == attechTxt.getId()) {
...
//        return Uri.fromFile(getOutputMediaFile(type));
    ...
    class ImageSourceDialog implements Runnable {
        ...
        public void run() {
            ...
            LinearLayout cameraArea = (LinearLayout) dialog_img_update.findViewById(R.id.cameraArea);
            LinearLayout galleryArea = (LinearLayout) dialog_img_update.findViewById(R.id.galleryArea);
            LinearLayout prescriptionArea = (LinearLayout) dialog_img_update.findViewById(R.id.prescriptionArea);
            chooseImgHTxt.setText(generalFunc.retrieveLangLBl("Upload Prescription", "LBL_PRESCRIPTION_UPLOAD"));
            ...
            cameraArea.setOnClickListener(v -> {
            ...
            galleryArea.setOnClickListener(v -> {
