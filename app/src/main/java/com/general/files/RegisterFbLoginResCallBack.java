...
import com.levaeu.passenger.AccountverificationActivity;
import com.levaeu.passenger.AppLoignRegisterActivity;
...
public class RegisterFbLoginResCallBack implements FacebookCallback<LoginResult> {
    ...
    public void setGeneralData(String userProfileJsonObjData) {
        ...
        storeData.put(Utils.ENABLE_GOPAY_KEY, generalFunc.getJsonValueStr(Utils.ENABLE_GOPAY_KEY, userProfileJsonObj));
