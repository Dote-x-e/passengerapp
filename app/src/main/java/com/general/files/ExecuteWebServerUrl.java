...
public class ExecuteWebServerUrl {
    ...
    public ExecuteWebServerUrl(Context mContext, String directUrl, boolean directUrl_value) {
        ...
        public void setLoaderConfig (Context mContext,boolean isLoaderShown, GeneralFunctions
        generalFunc){
        ...
        public void setIsDeviceTokenGenerate ( boolean isGenerateDeviceToken, String
        key_DeviceToken_param, GeneralFunctions generalFunc){
        ...
        public void performPostCall () {
            ...
            if (isStringResponse) {
                ...
                Call<ResponseBody> call = RestClient.getClient("POST", CommonUtilities.SERVER, mContext, new ToStringConverterFactory()).getStringResponse(CommonUtilities.SERVER_WEBSERVICE_PATH, parameters);

                call.enqueue(new Callback<ResponseBody>() {
                    @Override
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
//                    Logger.d("TIME_STAMP", "End Call to Server::" + System.currentTimeMillis());
                ...
                if (isObjectTypeParam && parametersObj != null) {
                    ...
                    call = RestClient.getClient("POST", CommonUtilities.SERVER, mContext).getResponseObj(CommonUtilities.SERVER_WEBSERVICE_PATH, parametersObj);
                } else {
                    Logger.d("Parameters", "::" + parameters.toString());

                    call = RestClient.getClient("POST", CommonUtilities.SERVER, mContext).getResponse(CommonUtilities.SERVER_WEBSERVICE_PATH, parameters);
                }
