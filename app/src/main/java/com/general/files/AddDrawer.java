...
import com.levaeu.passenger.CardPaymentActivity;
import com.levaeu.passenger.ContactUsActivity;
import com.levaeu.passenger.EmergencyContactActivity;
import com.levaeu.passenger.HelpActivity;
import com.levaeu.passenger.HistoryActivity;
import com.levaeu.passenger.InviteFriendsActivity;
import com.levaeu.passenger.MainActivity;
import com.levaeu.passenger.MyBookingsActivity;
import com.levaeu.passenger.MyProfileActivity;
import com.levaeu.passenger.MyWalletActivity;

import com.levaeu.passenger.R;
import com.levaeu.passenger.SettingActivity;
import com.levaeu.passenger.StaticPageActivity;
import com.levaeu.passenger.SupportActivity;
import com.levaeu.passenger.UberXActivity;
import com.levaeu.passenger.VerifyInfoActivity;
...
//        isMenuState = true;
    ...
    public void buildDrawer() {
        ...
        boolean CURRENCY_OPTIONAL=generalFunc.retrieveValue("CURRENCY_OPTIONAL").equalsIgnoreCase("Yes");
        boolean LANGUAGE_OPTIONAL=generalFunc.retrieveValue("LANGUAGE_OPTIONAL").equalsIgnoreCase("Yes");

        if (isDeliverOnlyEnabled && generalFunc.getMemberId().equals("") && (CURRENCY_OPTIONAL==false || LANGUAGE_OPTIONAL==false))
        {
            list_menu_items.add(new String[]{"" + R.mipmap.ic_setting, generalFunc.retrieveLangLBl("Support", "LBL_PREFRANCE_TXT"), "" + CommonUtilities.MENU_SETTING});
        }
    ...
    public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
        ...
        switch (itemId) {
            ...
            case Utils.MENU_SIGN_OUT:
                ...
                break;
            case CommonUtilities.MENU_SETTING:
                new StartActProcess(mContext).startAct(SettingActivity.class);
